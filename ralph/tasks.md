...
- [x] **services-search**: `ollygarden services search [query]`
...
- [x] **services-get**: `ollygarden services get <id>`
...
- [x] **services-versions**: `ollygarden services versions <id>`
...
- [x] **services-insights**: `ollygarden services insights <id>`
...
- [x] **insights-list**: `ollygarden insights list`
...
- [x] **insights-get**: `ollygarden insights get <id>`
...
- [x] **analytics-services**: `ollygarden analytics services`
...
- [x] **webhooks-deliveries-list**: `ollygarden webhooks deliveries list <webhook-id>`
...
- [x] **webhooks-deliveries-get**: `ollygarden webhooks deliveries get <webhook-id> <delivery-id>`
...
- [x] **webhooks-delete**: `ollygarden webhooks delete <id>`
